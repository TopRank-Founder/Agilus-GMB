    ...
    return (
        <div className="min-h-screen bg-white font-sans p-8">
            ...
            <div className="max-w-4xl mx-auto">
                <h1 className="text-5xl font-black mb-8 text-[#202124]">About {LOCALIZATION.BRAND.NAME} Mohali</h1>
                <div className="space-y-6 text-google-grey text-lg leading-relaxed">
                    <p>{LOCALIZATION.BRAND.NAME} ({LOCALIZATION.BRAND.SUBBRAND.toLowerCase()}) in Mohali {LOCALIZATION.BRAND.LOCATION} is part of India's leading laboratory network. We bring international standards of diagnostics to your doorstep.</p>
