    ...
    return (
        <div className="min-h-screen bg-white font-sans p-8">
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <p className="text-lg text-google-grey mb-12">{LOCALIZATION.BRAND.NAME} Mohali offers a comprehensive range of high-quality pathology and diagnostic services, utilizing MNC-standard automated equipment for reliable results.</p>
